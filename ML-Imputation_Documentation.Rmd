...
The Census Teaching File was a complete dataset. As a result, missingness was simulated using the following code.
...
Imputation models were derived for the following variables in the Census Teaching File:  
- Economic Activity, which was a multi-level categorical variable that gauged the type of work respondents carried out over the reference week. For the variable in the dataset, respondents could be categorised into one of the following groups:  
    - Employee  
    - Self-employed  
    - Unemployed  
    - Full-time student  
    ...
    - Economically inactive: Other Reason  
    - No code required (under 16 years of age or students or school children living away during term time)  
- Hours worked, which was a multi-level categorical variable that measured the number of hours worked over the reference week. Respondents could be categorised into one of the following groups:  
    - 15 or less hours worked  
    - 16 to 30 hours worked  
    - 31 to 48 hours worked  
    - 49 or more hours worked  
    - No code required (under 16 years of age or students or school children living away during term time)  
- Student, which was a binary variable that reflects whether respondents' study status. Respondents were grouped as follows:  
    - A school child or in full time study  
    - Not a school child or in full time study  
- Social Grade, which was a multi-level categorical variable that reflects the respondents' socio economic status. Respondents could be categorised into the following groups:  
